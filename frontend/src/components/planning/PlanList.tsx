      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {!loading && plans.length === 0 && (
          <div className="flex flex-col items-center justify-center gap-2 px-4 py-10 text-center">
            ...
            <button
              onClick={onNewPlan}
              className="mt-1 rounded-md bg-[color:var(--accent)] px-3 py-1.5 text-xs font-medium text-[color:var(--accent-foreground)] hover:bg-[color:var(--accent-strong)] transition"
            >
