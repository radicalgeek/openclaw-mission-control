...
const columns: Array<{
...
}> = [
  {
    ...
    status: "inbox",
    dot: "bg-neutral",
    accent: "hover:border-neutral-border hover:bg-[color:var(--surface-strong)]",
    text: "group-hover:text-[color:var(--text)] text-[color:var(--text-muted)]",
    badge: "bg-[color:var(--surface-strong)] text-[color:var(--text-muted)]",
  },
  {
    title: "In Progress",
    status: "in_progress",
    ...
    dot: "bg-brand",
    accent: "hover:border-[color:var(--accent)] hover:bg-[color:var(--accent-soft)]",
    text: "group-hover:text-[color:var(--accent-text-on-soft)] text-[color:var(--text-muted)]",
    badge: "bg-[color:var(--accent-soft)] text-[color:var(--accent-text-on-soft)]",
  },
  {
    title: "Review",
    status: "review",
    dot: "bg-info",
    accent: "hover:border-info-border hover:bg-info-soft",
    text: "group-hover:text-info text-[color:var(--text-muted)]",
  ...
  },
  {
    ...
    status: "done",
    dot: "bg-success",
    accent: "hover:border-success-border hover:bg-success-soft",
    text: "group-hover:text-success text-[color:var(--text-muted)]",
    ...
    >
      {columns.map((column) => {
        ...
        return (
          ...
          >
            <div className="column-header z-10 rounded-t-xl border border-b-0 border-[color:var(--border)] bg-[color:var(--surface)] px-4 py-3 sm:sticky sm:top-0 sm:bg-[color:var(--surface)] sm:backdrop-blur">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        reviewBucket === option.key
                          ...
                          : "border-[color:var(--border)] bg-[color:var(--surface-muted)] text-[color:var(--text-muted)] hover:border-[color:var(--border-strong)] hover:bg-[color:var(--surface-strong)]",
                      )}
