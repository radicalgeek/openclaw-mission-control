...
import type {
  ...
  ListSelfBoardsApiV1AgentSelfBoardsGetParams,
...
Useful for standalone agents that need to inspect their own metadata, type, gateway binding, or installed skills.
 * @summary Fetch caller's own agent record
 */
export type getSelfApiV1AgentSelfGetResponse200 = {
  data: AgentRead;
  status: 200;
};

export type getSelfApiV1AgentSelfGetResponse422 = {
  data: HTTPValidationError;
  status: 422;
};

export type getSelfApiV1AgentSelfGetResponseSuccess =
  getSelfApiV1AgentSelfGetResponse200 & {
    headers: Headers;
  };
export type getSelfApiV1AgentSelfGetResponseError =
  getSelfApiV1AgentSelfGetResponse422 & {
    headers: Headers;
  };

export type getSelfApiV1AgentSelfGetResponse =
  | getSelfApiV1AgentSelfGetResponseSuccess
  | getSelfApiV1AgentSelfGetResponseError;

export const getGetSelfApiV1AgentSelfGetUrl = () => {
  return `/api/v1/agent/self`;
};

export const getSelfApiV1AgentSelfGet = async (
  options?: RequestInit,
): Promise<getSelfApiV1AgentSelfGetResponse> => {
  return customFetch<getSelfApiV1AgentSelfGetResponse>(
    getGetSelfApiV1AgentSelfGetUrl(),
    {
      ...options,
      method: "GET",
    },
...
export const getGetSelfApiV1AgentSelfGetQueryKey = () => {
  return [`/api/v1/agent/self`] as const;
};

export const getGetSelfApiV1AgentSelfGetQueryOptions = <
  TData = Awaited<ReturnType<typeof getSelfApiV1AgentSelfGet>>,
  TError = HTTPValidationError,
>(options?: {
  query?: Partial<
    UseQueryOptions<
      Awaited<ReturnType<typeof getSelfApiV1AgentSelfGet>>,
      TError,
      TData
    >
  >;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetSelfApiV1AgentSelfGetQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getSelfApiV1AgentSelfGet>>
  > = ({ signal }) => getSelfApiV1AgentSelfGet({ signal, ...requestOptions });
...
export type GetSelfApiV1AgentSelfGetQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSelfApiV1AgentSelfGet>>
>;
export type GetSelfApiV1AgentSelfGetQueryError = HTTPValidationError;

export function useGetSelfApiV1AgentSelfGet<
  TData = Awaited<ReturnType<typeof getSelfApiV1AgentSelfGet>>,
  TError = HTTPValidationError,
>(
  options: {
...
>(
  ...
  const queryOptions = getGetSelfApiV1AgentSelfGetQueryOptions(options);
...
Board-scoped agents will receive their own board. Main gateway agents see all org boards.
 * @summary List boards accessible to the current standalone agent
 */
export type listSelfBoardsApiV1AgentSelfBoardsGetResponse200 = {
  data: LimitOffsetPageTypeVarCustomizedBoardRead;
  status: 200;
};

export type listSelfBoardsApiV1AgentSelfBoardsGetResponse422 = {
  data: HTTPValidationError;
  status: 422;
};

export type listSelfBoardsApiV1AgentSelfBoardsGetResponseSuccess =
  listSelfBoardsApiV1AgentSelfBoardsGetResponse200 & {
    headers: Headers;
  };
export type listSelfBoardsApiV1AgentSelfBoardsGetResponseError =
  listSelfBoardsApiV1AgentSelfBoardsGetResponse422 & {
    headers: Headers;
  };

export type listSelfBoardsApiV1AgentSelfBoardsGetResponse =
  | listSelfBoardsApiV1AgentSelfBoardsGetResponseSuccess
  | listSelfBoardsApiV1AgentSelfBoardsGetResponseError;

export const getListSelfBoardsApiV1AgentSelfBoardsGetUrl = (
  params?: ListSelfBoardsApiV1AgentSelfBoardsGetParams,
) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0
    ? `/api/v1/agent/self/boards?${stringifiedParams}`
    : `/api/v1/agent/self/boards`;
};

export const listSelfBoardsApiV1AgentSelfBoardsGet = async (
  params?: ListSelfBoardsApiV1AgentSelfBoardsGetParams,
  options?: RequestInit,
): Promise<listSelfBoardsApiV1AgentSelfBoardsGetResponse> => {
  return customFetch<listSelfBoardsApiV1AgentSelfBoardsGetResponse>(
    getListSelfBoardsApiV1AgentSelfBoardsGetUrl(params),
    {
      ...options,
      method: "GET",
    },
...
export const getListSelfBoardsApiV1AgentSelfBoardsGetQueryKey = (
  params?: ListSelfBoardsApiV1AgentSelfBoardsGetParams,
) => {
  return [`/api/v1/agent/self/boards`, ...(params ? [params] : [])] as const;
};

export const getListSelfBoardsApiV1AgentSelfBoardsGetQueryOptions = <
  TData = Awaited<ReturnType<typeof listSelfBoardsApiV1AgentSelfBoardsGet>>,
  TError = HTTPValidationError,
>(
  params?: ListSelfBoardsApiV1AgentSelfBoardsGetParams,
  options?: {
    query?: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof listSelfBoardsApiV1AgentSelfBoardsGet>>,
        TError,
        TData
      >
    >;
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getListSelfBoardsApiV1AgentSelfBoardsGetQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listSelfBoardsApiV1AgentSelfBoardsGet>>
  > = ({ signal }) =>
    listSelfBoardsApiV1AgentSelfBoardsGet(params, {
      signal,
      ...requestOptions,
    });
...
export type ListSelfBoardsApiV1AgentSelfBoardsGetQueryResult = NonNullable<
  Awaited<ReturnType<typeof listSelfBoardsApiV1AgentSelfBoardsGet>>
>;
export type ListSelfBoardsApiV1AgentSelfBoardsGetQueryError =
  HTTPValidationError;

export function useListSelfBoardsApiV1AgentSelfBoardsGet<
  TData = Awaited<ReturnType<typeof listSelfBoardsApiV1AgentSelfBoardsGet>>,
  TError = HTTPValidationError,
>(
  params: undefined | ListSelfBoardsApiV1AgentSelfBoardsGetParams,
  options: {
    query: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof listSelfBoardsApiV1AgentSelfBoardsGet>>,
...
>(
  ...
  const queryOptions = getListSelfBoardsApiV1AgentSelfBoardsGetQueryOptions(
    params,
    options,
  );
 ...
 */
export type listSelfWebhooksApiV1AgentSelfWebhooksGetResponse200 = {
  data: AgentWebhookRead[];
  status: 200;
};

export type listSelfWebhooksApiV1AgentSelfWebhooksGetResponse422 = {
  data: HTTPValidationError;
  status: 422;
};

export type listSelfWebhooksApiV1AgentSelfWebhooksGetResponseSuccess =
  listSelfWebhooksApiV1AgentSelfWebhooksGetResponse200 & {
    headers: Headers;
  };
export type listSelfWebhooksApiV1AgentSelfWebhooksGetResponseError =
  listSelfWebhooksApiV1AgentSelfWebhooksGetResponse422 & {
    headers: Headers;
  };

export type listSelfWebhooksApiV1AgentSelfWebhooksGetResponse =
  | listSelfWebhooksApiV1AgentSelfWebhooksGetResponseSuccess
  | listSelfWebhooksApiV1AgentSelfWebhooksGetResponseError;

export const getListSelfWebhooksApiV1AgentSelfWebhooksGetUrl = () => {
  return `/api/v1/agent/self/webhooks`;
};

export const listSelfWebhooksApiV1AgentSelfWebhooksGet = async (
  options?: RequestInit,
): Promise<listSelfWebhooksApiV1AgentSelfWebhooksGetResponse> => {
  return customFetch<listSelfWebhooksApiV1AgentSelfWebhooksGetResponse>(
    getListSelfWebhooksApiV1AgentSelfWebhooksGetUrl(),
    {
      ...options,
      method: "GET",
    },
...
export const getListSelfWebhooksApiV1AgentSelfWebhooksGetQueryKey = () => {
  return [`/api/v1/agent/self/webhooks`] as const;
};

export const getListSelfWebhooksApiV1AgentSelfWebhooksGetQueryOptions = <
  TData = Awaited<ReturnType<typeof listSelfWebhooksApiV1AgentSelfWebhooksGet>>,
  TError = HTTPValidationError,
>(options?: {
  query?: Partial<
    UseQueryOptions<
      Awaited<ReturnType<typeof listSelfWebhooksApiV1AgentSelfWebhooksGet>>,
      TError,
      TData
    >
  >;
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getListSelfWebhooksApiV1AgentSelfWebhooksGetQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listSelfWebhooksApiV1AgentSelfWebhooksGet>>
  > = ({ signal }) =>
    listSelfWebhooksApiV1AgentSelfWebhooksGet({ signal, ...requestOptions });
...
export type ListSelfWebhooksApiV1AgentSelfWebhooksGetQueryResult = NonNullable<
  Awaited<ReturnType<typeof listSelfWebhooksApiV1AgentSelfWebhooksGet>>
>;
export type ListSelfWebhooksApiV1AgentSelfWebhooksGetQueryError =
  HTTPValidationError;

export function useListSelfWebhooksApiV1AgentSelfWebhooksGet<
  TData = Awaited<ReturnType<typeof listSelfWebhooksApiV1AgentSelfWebhooksGet>>,
  TError = HTTPValidationError,
>(
  options: {
...
>(
  ...
  const queryOptions =
    getListSelfWebhooksApiV1AgentSelfWebhooksGetQueryOptions(options);
