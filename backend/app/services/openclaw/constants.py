...
ROLE_TEMPLATE_HEARTBEAT_PROMPT: dict[str, str] = {
    "estimator": (
        ...
        "or priority subset. Use the tasks?is_backlog=true query for discovery "
        "and verification; do not use status=backlog. You may return HEARTBEAT_OK only after a fresh "
